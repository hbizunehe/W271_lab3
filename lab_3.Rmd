...
* For each 'i' the model is $y_{it} = \beta_1 x_{it1} + ... + \beta_k x_{itk} + a_i + u_{it}, t =1 ..T$
...
### Consequences of inapproriately using a random effect model
...
stargazer(pooled_ols, expanded.ols, expanded.within, omit=c('year'),
