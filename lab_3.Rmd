...
> States where highway speeds were made over 70mph during the middle of the year contained a frcational value for that year. The fraction was thresholded at 0.5 to make this a binary variable. As there is no meaningful interpretation for this variable as a continuous value, this thresholding was neccesary to convert it into a factor.

> A state can have a primary, secondary or no seat belt laws. The seat_belt_law reflects these three factors compbined into one variable. 

> Graduated drivers licence law and per-se law parameters both have frcational value for years wwhere the law was implemented mid-year. The fractions was threolded at 0.5 to make this a binary variable. As there is no meaningful interpretation for these variables as a continuous value, this thresholding was neccesary to convert them into a factor.
...
> None of the continous variables, namely, unemployment rate, miles drive per capita, rate of 14 to 24 aged people in population required any transformation. This can be seen in the correlation plots in Figure y.
...
> We note that the seat belt law factors are not statistically significant.
...
> In this model we note that seat belt primary law is a signifcant factor. This model suggests that having a primary seat belt law is associated with a ```r abs(round(coef(expanded.within)['seat_belt_lawprimary'], 2))``` unit decrease in fatality rate as compared to not having  primary seat belt law. 
